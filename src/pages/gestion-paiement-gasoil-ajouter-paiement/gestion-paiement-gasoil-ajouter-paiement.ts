...
/**
 * Generated class for the GestionPaiementGasoilAjouterPaiementPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-gasoil-ajouter-paiement',
  templateUrl: 'gestion-paiement-gasoil-ajouter-paiement.html',
})
export class GestionPaiementGasoilAjouterPaiementPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    (this.objetActuel as any).refstationpaiement = (this.objetActuel as any).refstation;
