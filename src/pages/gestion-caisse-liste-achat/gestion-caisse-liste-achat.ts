...
import {GestionCaisseAjouterAchatPage} from "../gestion-caisse-ajouter-achat/gestion-caisse-ajouter-achat";

/**
 * Generated class for the GestionCaisseListeAchatPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-caisse-liste-achat',
  templateUrl: 'gestion-caisse-liste-achat.html',
})
export class GestionCaisseListeAchatPage {
  ...
  public nomTableActuelle = "achatcaisse";

  //la liste des tables suivantes
  public pageDAjout : any = GestionCaisseAjouterAchatPage;
  public pageSuivante : any = null;

  public tableauMappingBDD = [
    ["idachatcaisse","id","number"],
    ["designationachatcaisse","designation","text"],
    ["photoachatcaisse","photo","text"],
    ["quantiteachatcaisse","quantite","number"],
    ["prixachatcaisse","prix","number"],
    ["dateachatcaisse","date","date"],
    ["reffournisseurcaisseachatcaisse","reffournisseurcaisse","number"],
  ];
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"","reffournisseurcaisse = " + (this.informationsActuelles as any).idfournisseurcaisse,[],true,"")
      .subscribe(data => {
