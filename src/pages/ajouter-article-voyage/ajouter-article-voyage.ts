...
/**
 * Generated class for the AjouterArticleVoyagePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ajouter-article-voyage',
  templateUrl: 'ajouter-article-voyage.html',
})
export class AjouterArticleVoyagePage {
  ...
  public listeChoixArticleSousDemande = [];
