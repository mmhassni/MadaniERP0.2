...
/**
 * Generated class for the GestionArticleProjetAjouterArticleProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-article-projet-ajouter-article-projet',
  templateUrl: 'gestion-article-projet-ajouter-article-projet.html',
})
export class GestionArticleProjetAjouterArticleProjetPage {
  ...
  public listeChoixCategorieArticleProjet = [];
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    this.recupererListeChoix("listeChoixCategorieArticleProjet","categoriearticleprojet","id","nom",[],"",[]);
