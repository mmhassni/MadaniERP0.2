...
import {GestionPaiementOuvrierSelectionDatePage} from "../gestion-paiement-ouvrier-selection-date/gestion-paiement-ouvrier-selection-date";
import {HttpClient} from "@angular/common/http";
import {GestionPaiementFournisseurSelectionDatePage} from "../gestion-paiement-fournisseur-selection-date/gestion-paiement-fournisseur-selection-date";

/**
 * Generated class for the GestionPaiementFournisseurListeChantierPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-fournisseur-liste-chantier',
  templateUrl: 'gestion-paiement-fournisseur-liste-chantier.html',
})
export class GestionPaiementFournisseurListeChantierPage {
  ...
  public pageSuivante : any = GestionPaiementFournisseurSelectionDatePage;
