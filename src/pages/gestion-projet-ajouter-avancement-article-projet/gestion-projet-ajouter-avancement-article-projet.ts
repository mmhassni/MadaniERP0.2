...
/**
 * Generated class for the GestionProjetAjouterAvancementArticleProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-projet-ajouter-avancement-article-projet',
  templateUrl: 'gestion-projet-ajouter-avancement-article-projet.html',
})
export class GestionProjetAjouterAvancementArticleProjetPage {
