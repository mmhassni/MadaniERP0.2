...
/**
 * Generated class for the AjouterProjetFournisseurAssociePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ajouter-projet-fournisseur-associe',
  templateUrl: 'ajouter-projet-fournisseur-associe.html',
})
export class AjouterProjetFournisseurAssociePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController) {
    ...
    this.recupererListeChoix("listeProjetChoix","projet","id","nomprojet")
