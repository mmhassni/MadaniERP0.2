...
/**
 * Generated class for the GestionArticleProjetAjouterProjetAssociePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-article-projet-ajouter-projet-associe',
  templateUrl: 'gestion-article-projet-ajouter-projet-associe.html',
})
export class GestionArticleProjetAjouterProjetAssociePage {
  ...
  public tableObjetAAssocier = "projet";
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    (this.objetActuel as any).refarticleprojetprojetarticleprojetassocie = (this.objetActuel as any).idarticleprojet;
