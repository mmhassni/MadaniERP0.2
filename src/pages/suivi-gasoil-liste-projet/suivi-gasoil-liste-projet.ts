...
import {SuiviGasoilListeChantierPage} from "../suivi-gasoil-liste-chantier/suivi-gasoil-liste-chantier";
import {AjouterProjetPage} from "../ajouter-projet/ajouter-projet";

/**
 * Generated class for the SuiviGasoilListeProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-suivi-gasoil-liste-projet',
  templateUrl: 'suivi-gasoil-liste-projet.html',
})
export class SuiviGasoilListeProjetPage {
  ...
  public pageSuivante : any = SuiviGasoilListeChantierPage;
