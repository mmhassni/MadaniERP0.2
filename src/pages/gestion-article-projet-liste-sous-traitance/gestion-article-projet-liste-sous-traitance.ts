...
import {GestionArticleProjetAjouterSousTraitancePage} from "../gestion-article-projet-ajouter-sous-traitance/gestion-article-projet-ajouter-sous-traitance";

/**
 * Generated class for the GestionArticleProjetListeSousTraitancePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-article-projet-liste-sous-traitance',
  templateUrl: 'gestion-article-projet-liste-sous-traitance.html',
})
export class GestionArticleProjetListeSousTraitancePage {
  ...
  public pageDAjout : any = GestionArticleProjetAjouterSousTraitancePage;
  public pageSuivante : any = null;

  public tableauMappingBDD = [
    ["idsoustraitance","id","number"],
    ["prixsoustraitance","prix","number"],
    ["quantitesoustraitance","quantite","number"],
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"intervenant.nom as nomintervenant, intervenant.raisonsociale as raisonsocialeintervenant","",["intervenant"],true,"")
      .subscribe(data => {
