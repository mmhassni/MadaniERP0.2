...
import {GestionPaiementGasoilAjouterPaiementPage} from "../gestion-paiement-gasoil-ajouter-paiement/gestion-paiement-gasoil-ajouter-paiement";

/**
 * Generated class for the GestionPaiementGasoilListePaiementPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-gasoil-liste-paiement',
  templateUrl: 'gestion-paiement-gasoil-liste-paiement.html',
})
export class GestionPaiementGasoilListePaiementPage {
  ...
  public pageDAjout : any = GestionPaiementGasoilAjouterPaiementPage;
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,
      "",
      "refstation = " + (this.informationsActuelles as any).refstation + " and  refchantier = " +
      (this.informationsActuelles as any).idchantier +
      " and not refstation is null and  datedebut" + " between '" + new Date((this.informationsActuelles as any).moisdebut + "-01").toISOString().substring(0,10) + "'" +
