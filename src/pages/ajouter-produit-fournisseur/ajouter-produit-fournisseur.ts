...
/**
 * Generated class for the AjouterProduitFournisseurPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ajouter-produit-fournisseur',
  templateUrl: 'ajouter-produit-fournisseur.html',
})
export class AjouterProduitFournisseurPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController) {
    ...
    (this.objetActuel as any).reffournisseur = (this.objetActuel as any).idfournisseur;
