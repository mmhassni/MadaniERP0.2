...
import {GestionArticleProjetAjouterProjetAssociePage} from "../gestion-article-projet-ajouter-projet-associe/gestion-article-projet-ajouter-projet-associe";
import {GestionArticleProjetListeSousTraitancePage} from "../gestion-article-projet-liste-sous-traitance/gestion-article-projet-liste-sous-traitance";

/**
 * Generated class for the GestionArticleProjetListeProjetAssociePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-article-projet-liste-projet-associe',
  templateUrl: 'gestion-article-projet-liste-projet-associe.html',
})
export class GestionArticleProjetListeProjetAssociePage {
  ...
  public nomTableActuelle = "projetarticleprojetassocie";

  //la liste des tables suivantes
  public pageDAjout : any = GestionArticleProjetAjouterProjetAssociePage;
  public pageSuivante : any = GestionArticleProjetListeSousTraitancePage;
  ...
  public tableauMappingBDD = [
    ...
    ["refarticleprojetprojetarticleprojetassocie","refarticleprojet","number"],
    ["refprojetprojetarticleprojetassocie","refprojet","number"]
  ];
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"","projetarticleprojetassocie.refarticleprojet =  " + (this.informationsActuelles as any).idarticleprojet,["projet"],true,"")
      .subscribe(data => {
