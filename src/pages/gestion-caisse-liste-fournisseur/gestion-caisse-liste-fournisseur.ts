...
import {GestionCaisseListeAchatPage} from "../gestion-caisse-liste-achat/gestion-caisse-liste-achat";
import {GestionCaisseAjouterFournisseurPage} from "../gestion-caisse-ajouter-fournisseur/gestion-caisse-ajouter-fournisseur";

/**
 * Generated class for the GestionCaisseListeFournisseurPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-caisse-liste-fournisseur',
  templateUrl: 'gestion-caisse-liste-fournisseur.html',
})
export class GestionCaisseListeFournisseurPage {
  ...
  public nomTableActuelle = "fournisseurcaisse";




  //la liste des tables suivantes
  public pageDAjout : any = GestionCaisseAjouterFournisseurPage;
  public pageSuivante: any = GestionCaisseListeAchatPage;

  public tableauMappingBDD = [
    ["idfournisseurcaisse","id","number"],
    ["nomfournisseurcaisse","nom","text"],
    ["adressefournisseurcaisse","adresse","text"],
    ["contactfournisseurcaisse","contact","text"],
    ["patentefournisseurcaisse","patente","text"],
    ["refprojetfournisseurcaisse","refprojet","number"]
