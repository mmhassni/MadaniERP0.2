...
import {GestionIncidentListeChantierPage} from "../gestion-incident-liste-chantier/gestion-incident-liste-chantier";

/**
 * Generated class for the GestionIncidentListeProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-incident-liste-projet',
  templateUrl: 'gestion-incident-liste-projet.html',
})
export class GestionIncidentListeProjetPage {
  ...
  public pageSuivante : any = GestionIncidentListeChantierPage;
