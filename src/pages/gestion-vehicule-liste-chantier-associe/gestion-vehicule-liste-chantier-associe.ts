...
import {GestionVehiculeAjouterChantierAssociePage} from "../gestion-vehicule-ajouter-chantier-associe/gestion-vehicule-ajouter-chantier-associe";

/**
 * Generated class for the GestionVehiculeListeChantierAssociePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-vehicule-liste-chantier-associe',
  templateUrl: 'gestion-vehicule-liste-chantier-associe.html',
})
export class GestionVehiculeListeChantierAssociePage {
  ...
  public pageDAjout : any = GestionVehiculeAjouterChantierAssociePage;
  ...
  public tableauMappingBDD = [
    ...
    refresh(){
      ...
      this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"chantier.nom as nomchantier, chantier.id as idchantier","refvehicule = " + (this.informationsActuelles as any).idvehicule,["chantier"],true)
        .subscribe(data => {
