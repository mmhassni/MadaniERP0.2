...
/**
 * Generated class for the GestionCaisseAjouterFournisseurPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-caisse-ajouter-fournisseur',
  templateUrl: 'gestion-caisse-ajouter-fournisseur.html',
})


export class GestionCaisseAjouterFournisseurPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    (this.objetActuel as any).refprojetfournisseurcaisse =  (this.objetActuel as any).idprojet  ;
