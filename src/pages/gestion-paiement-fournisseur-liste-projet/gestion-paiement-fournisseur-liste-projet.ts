...
/**
 * Generated class for the GestionPaiementFournisseurListeProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-fournisseur-liste-projet',
  templateUrl: 'gestion-paiement-fournisseur-liste-projet.html',
})
export class GestionPaiementFournisseurListeProjetPage {
  ...
  public pageSuivante : any = GestionPaiementFournisseurListeChantierPage;
