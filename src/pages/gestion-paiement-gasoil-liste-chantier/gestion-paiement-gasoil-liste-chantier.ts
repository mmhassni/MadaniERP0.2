...
import {GestionPaiementGasoilSelectionDatePage} from "../gestion-paiement-gasoil-selection-date/gestion-paiement-gasoil-selection-date";

/**
 * Generated class for the GestionPaiementGasoilListeChantierPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-gasoil-liste-chantier',
  templateUrl: 'gestion-paiement-gasoil-liste-chantier.html',
})
export class GestionPaiementGasoilListeChantierPage {
  ...
  public pageSuivante : any = GestionPaiementGasoilSelectionDatePage;
