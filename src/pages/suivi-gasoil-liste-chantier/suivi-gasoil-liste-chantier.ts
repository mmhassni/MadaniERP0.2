...
import {SuiviGasoilListeBonGasoilPage} from "../suivi-gasoil-liste-bon-gasoil/suivi-gasoil-liste-bon-gasoil";

/**
 * Generated class for the SuiviGasoilListeChantierPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-suivi-gasoil-liste-chantier',
  templateUrl: 'suivi-gasoil-liste-chantier.html',
})
export class SuiviGasoilListeChantierPage {
  ...
  public pageSuivante : any = SuiviGasoilListeBonGasoilPage;
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"","chantier.refprojet = " + (this.informationsActuelles as any).idprojet,["projet"])
      .subscribe(data => {
