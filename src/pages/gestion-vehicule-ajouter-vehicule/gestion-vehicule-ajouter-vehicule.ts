...
/**
 * Generated class for the GestionVehiculeAjouterVehiculePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-vehicule-ajouter-vehicule',
  templateUrl: 'gestion-vehicule-ajouter-vehicule.html',
})
export class GestionVehiculeAjouterVehiculePage {
