...
import {GestionIncidentAjouterIncidentPage} from "../gestion-incident-ajouter-incident/gestion-incident-ajouter-incident";

/**
 * Generated class for the GestionIncidentListeIncidentPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-incident-liste-incident',
  templateUrl: 'gestion-incident-liste-incident.html',
})
export class GestionIncidentListeIncidentPage {
  ...
  public nomTableActuelle = "incident";




  //la liste des tables suivantes
  public pageDAjout : any = GestionIncidentAjouterIncidentPage;
  public pageSuivante : any = null;

  public tableauMappingBDD = [
    ["idincident","id","number"],
    ["objetincident","objet","text"],
    ["observationincident","observation","text"],
    ["photoincident","photo","text"],
    ["dateincident","date","date"],
    ["refutilisateurincident","refutilisateur","number"],
    ["refchantierincident","refchantier","number"]
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"","refchantier = " +(this.informationsActuelles as any).idchantier,[],true,"")
      .subscribe(data => {
