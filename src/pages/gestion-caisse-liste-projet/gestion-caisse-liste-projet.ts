...
import {GestionCaisseListeFournisseurPage} from "../gestion-caisse-liste-fournisseur/gestion-caisse-liste-fournisseur";

/**
 * Generated class for the GestionCaisseListeProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-caisse-liste-projet',
  templateUrl: 'gestion-caisse-liste-projet.html',
})
export class GestionCaisseListeProjetPage {
  ...
  public pageSuivante : any = GestionCaisseListeFournisseurPage;
