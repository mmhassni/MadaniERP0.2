...
import {GestionPaiementOuvrierListeChantierPage} from "../gestion-paiement-ouvrier-liste-chantier/gestion-paiement-ouvrier-liste-chantier";

/**
 * Generated class for the GestionPaiementOuvrierListeProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-ouvrier-liste-projet',
  templateUrl: 'gestion-paiement-ouvrier-liste-projet.html',
})
export class GestionPaiementOuvrierListeProjetPage {
  ...
  public pageSuivante : any = GestionPaiementOuvrierListeChantierPage;
