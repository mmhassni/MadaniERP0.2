...
import {GestionPaiementFournisseurAjouterPaiementPage} from "../gestion-paiement-fournisseur-ajouter-paiement/gestion-paiement-fournisseur-ajouter-paiement";

/**
 * Generated class for the GestionPaiementFournisseurListePaiementPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-fournisseur-liste-paiement',
  templateUrl: 'gestion-paiement-fournisseur-liste-paiement.html',
})
export class GestionPaiementFournisseurListePaiementPage {
  ...
  public nomTableActuelle = "paiement";

  //la liste des tables suivantes
  public pageDAjout : any = GestionPaiementFournisseurAjouterPaiementPage;
  public pageSuivante : any = null;

  public tableauMappingBDD = [
    ["idpaiement","id","number"],
    ["numpiecepaiement","numpiece","text"],
    ["typepaiementpaiement","typepaiement","text"],
    ["montantpaiement","montant","number"],
    ["datepaiementpaiement","datepaiement","date"],
    ["pourpaiement","pour","text"],
    ["refbongasoilpaiement","refbongasoil","number"],
    ["refbanquepaiement","refbanque","number"],
    ["reffournisseurpaiement","reffournisseur","number"],
    ["refstationpaiement","refstation","number"],
    ["refprojetpaiement","refprojet","number"],
    ["refchantierpaiement","refchantier","number"],
  ];
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,
      "",
      "reffournisseur = " + (this.informationsActuelles as any).reffournisseur + " and  refchantier = " +
      (this.informationsActuelles as any).idchantier +
      " and not reffournisseur is null and  datedebut" + " between '" + new Date((this.informationsActuelles as any).moisdebut + "-01").toISOString().substring(0,10) + "'" +
      ...
      new Date((this.informationsActuelles as any).moisfin).getDate()).toISOString().substring(0,10) + "' and datefin" + " between '" + new Date((this.informationsActuelles as any).moisdebut + "-01").toISOString().substring(0,10) + "'" +
      " and '" + new Date((this.informationsActuelles as any).moisfin.substring(0,4) ,
      (this.informationsActuelles as any).moisfin.substring(5,7),
      new Date((this.informationsActuelles as any).moisfin).getDate()).toISOString().substring(0,10) + "'"   ,
      [],
      true,
      "")
      .subscribe(data => {
