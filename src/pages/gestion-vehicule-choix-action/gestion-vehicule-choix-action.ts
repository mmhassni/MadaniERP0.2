...
/**
 * Generated class for the GestionVehiculeChoixActionPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-vehicule-choix-action',
  templateUrl: 'gestion-vehicule-choix-action.html',
})
export class GestionVehiculeChoixActionPage {
