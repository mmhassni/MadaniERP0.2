...
/**
 * Generated class for the GestionIncidentAjouterIncidentPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-incident-ajouter-incident',
  templateUrl: 'gestion-incident-ajouter-incident.html',
})
export class GestionIncidentAjouterIncidentPage {
  ...
  public parametresPost = ["photoincident"];
  public parametresPostLibelle = ["Photo Incident"];
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    (this.objetActuel as any).refchantierincident = (this.objetActuel as any).idchantier;
