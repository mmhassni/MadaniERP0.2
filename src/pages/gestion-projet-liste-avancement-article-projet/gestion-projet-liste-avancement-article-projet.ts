...
import {GestionProjetAjouterAvancementArticleProjetPage} from "../gestion-projet-ajouter-avancement-article-projet/gestion-projet-ajouter-avancement-article-projet";

/**
 * Generated class for the GestionProjetListeAvancementArticleProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-projet-liste-avancement-article-projet',
  templateUrl: 'gestion-projet-liste-avancement-article-projet.html',
})
export class GestionProjetListeAvancementArticleProjetPage {
  ...
  public nomTableActuelle = "avancementarticleprojet";

  //la liste des tables suivantes
  public pageDAjout : any = GestionProjetAjouterAvancementArticleProjetPage;
  public pageSuivante : any = null;

  public tableauMappingBDD = [
    ["idavancementarticleprojet","id","number"],
