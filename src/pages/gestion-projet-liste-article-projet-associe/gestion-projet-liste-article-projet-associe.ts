...
@IonicPage()
@Component({
  selector: 'page-gestion-projet-liste-article-projet-associe',
  templateUrl: 'gestion-projet-liste-article-projet-associe.html',
})
export class GestionProjetListeArticleProjetAssociePage {
  ...
  refresh(){
    ...
    this.getListObjet(this.nomTableActuelle,this.tableauMappingBDD,"articleprojet.nom as nomarticleprojet","refprojet = " + (this.informationsActuelles as any).idprojet,["articleprojet"],true,"")
      .subscribe(data => {
