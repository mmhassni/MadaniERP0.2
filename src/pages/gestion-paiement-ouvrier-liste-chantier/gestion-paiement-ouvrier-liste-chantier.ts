...
/**
 * Generated class for the GestionPaiementOuvrierListeChantierPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-ouvrier-liste-chantier',
  templateUrl: 'gestion-paiement-ouvrier-liste-chantier.html',
})
export class GestionPaiementOuvrierListeChantierPage {
  ...
  public pageSuivante : any = GestionPaiementOuvrierSelectionDatePage;
