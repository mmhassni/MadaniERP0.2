...
import {GestionPaiementGasoilListePaiementPage} from "../gestion-paiement-gasoil-liste-paiement/gestion-paiement-gasoil-liste-paiement";

/**
 * Generated class for the GestionPaiementGasoilListeSommeSituationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-gasoil-liste-somme-situation',
  templateUrl: 'gestion-paiement-gasoil-liste-somme-situation.html',
})
export class GestionPaiementGasoilListeSommeSituationPage {
  ...
  public pageSuivante : any = GestionPaiementGasoilListePaiementPage;
  ...
  refresh(){
    ...
    this.httpClient.get("http://ec2-52-47-166-154.eu-west-3.compute.amazonaws.com:9090/requestAny/" +
      "select " +
        "bongasoil.refstation as refstation, " +
        "station.nom as nomstation, " +
        "sum(bongasoil.montantgasoil) as totalttc, " +
        "count(*) as nombrebongasoil " +
      "from bongasoil " +
      "left join station on station.id = bongasoil.refstation " +
      "where  " +
        "not  bongasoil.refstation is null  " +
        "and not bongasoil.montantgasoil is null " +
        "and not bongasoil.refchantier is null " +
        "and bongasoil.date between '" + new Date((this.informationsActuelles as any).moisdebut + "-01").toISOString().substring(0,10) + "'" +
        ...
        "and bongasoil.refchantier = "  + (this.informationsActuelles as any).idchantier + " " +
      "group by  bongasoil.refstation, station.nom"
    )
      .subscribe(data => {
