...
/**
 * Generated class for the GestionCaisseAjouterAchatPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-caisse-ajouter-achat',
  templateUrl: 'gestion-caisse-ajouter-achat.html',
})
export class GestionCaisseAjouterAchatPage {
  ...
  public parametresPost = ["photoachatcaisse"];
  public parametresPostLibelle = ["Photo Achat"];
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    (this.objetActuel as any).reffournisseurcaisseachatcaisse = (this.objetActuel as any).idfournisseurcaisse;
