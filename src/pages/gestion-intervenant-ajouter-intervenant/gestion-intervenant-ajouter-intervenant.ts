...
/**
 * Generated class for the GestionIntervenantAjouterIntervenantPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-intervenant-ajouter-intervenant',
  templateUrl: 'gestion-intervenant-ajouter-intervenant.html',
})
export class GestionIntervenantAjouterIntervenantPage {
