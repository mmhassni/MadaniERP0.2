...
import {GestionPaiementFournisseurListeChantierPage} from "../gestion-paiement-fournisseur-liste-chantier/gestion-paiement-fournisseur-liste-chantier";
import {HttpClient} from "@angular/common/http";
import {GestionPaiementGasoilListeChantierPage} from "../gestion-paiement-gasoil-liste-chantier/gestion-paiement-gasoil-liste-chantier";

/**
 * Generated class for the GestionPaiementGasoilListeProjetPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-gasoil-liste-projet',
  templateUrl: 'gestion-paiement-gasoil-liste-projet.html',
})
export class GestionPaiementGasoilListeProjetPage {
  ...
  public pageSuivante : any = GestionPaiementGasoilListeChantierPage;
