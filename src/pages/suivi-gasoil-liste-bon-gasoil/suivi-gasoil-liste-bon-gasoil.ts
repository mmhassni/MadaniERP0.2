...
export class SuiviGasoilListeBonGasoilPage {
  ...
  ajouterItemWithoutPush() {
    ...
    this.httpClient.get("http://ec2-52-47-166-154.eu-west-3.compute.amazonaws.com:9090/requestAny/insert into "+ this.nomTableActuelle +" (refchantier,date) values (" + (this.informationsActuelles as any).idchantier +
