...
/**
 * Generated class for the GestionPaiementFournisseurAjouterPaiementPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gestion-paiement-fournisseur-ajouter-paiement',
  templateUrl: 'gestion-paiement-fournisseur-ajouter-paiement.html',
})
export class GestionPaiementFournisseurAjouterPaiementPage {
  ...
  public tableauMappingBDD = [
    ...
    ["datedebutpaiement","datedebut","date"],
    ["datefinpaiement","datefin","date"]
  ];

  public enregistrementColonneIgnore = [];

  public listeChoixBanque = [];
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public httpClient : HttpClient,public toastCtrl : ToastController,  public cameraProvider : CameraProvider) {
    ...
    (this.objetActuel as any).refchantierpaiement = (this.objetActuel as any).idchantier;
    (this.objetActuel as any).reffournisseurpaiement = (this.objetActuel as any).reffournisseur;
    (this.objetActuel as any).datedebutpaiement = new Date((this.objetActuel as any).moisdebut + "-01").toISOString().substring(0,10) ;
    (this.objetActuel as any).datefinpaiement = new Date((this.objetActuel as any).moisfin.substring(0,4) ,
      (this.objetActuel as any).moisfin.substring(5,7),
      new Date((this.objetActuel as any).moisfin).getDate())
    ...
    this.recupererListeChoix("listeChoixBanque","banque","id","nom",[],"",[]);
